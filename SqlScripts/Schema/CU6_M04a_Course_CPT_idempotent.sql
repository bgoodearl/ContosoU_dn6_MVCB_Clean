...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220524225814_CU6_M04a_Course_CPT')
BEGIN
...
BEGIN
    ...
    VALUES (N'20220524225814_CU6_M04a_Course_CPT', N'6.0.2');
END;
GO
